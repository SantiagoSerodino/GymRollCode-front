...
const Footer = () => {
  ...
  return (
    <>
      <footer
        className={`py-2 footerMG container-fluid ${!showFooter && "d-none"}`}
      >
        <div className="row align-items-end justify-content-between border-bottom">
          ...
          <ul className="textoFooterMG my-2 col-md-4 justify-content-evenly list-unstyled d-flex">
            <li className="py-2 col-md-4 text-center">
              <Link to="/" className="nav-link text-white mx-2">
                Inicio
              </Link>
            </li>
            <li className="py-2 col-md-4 text-center">
              <Link to="/error" className="nav-link text-white mx-2">
                Planes-Fit
              </Link>
            </li>
            <li className="py-2 col-md-4 text-center">
        ...
        <div className="row justify-content-between align-items-center">
          <p className="col-12 col-sm-6 col-md-4 ps-3 ps-sm-5  mt-2 mb-md-0 text-white d-flex justify-content-start textoFooterMG">
            © 2023 GymRoll
          </p>
          <ul className="col-12 col-sm-6 col-md-4 mb-2 my-sm-2 pe-3 pe-sm-5 iconoFooterMG justify-content-end list-unstyled d-flex">
            ...
            <li className="ms-3">
              <a className="text-white" href="https://twitter.com/?lang=es">
