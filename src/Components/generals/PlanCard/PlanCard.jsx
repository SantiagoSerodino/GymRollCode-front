      ...
      <div className='container'>
        <div className='row justify-content-around '>
          ...
          <div className='planGym row col-md-4 col-12 py-4 px-2 m-1 justify-content-center'>
            ...
            <Link className='btn btn-outline-success w-75' to='/musculacion'>
              Accede a mas info del Plan
            </Link>
          </div>
          ...
          <div className='planGym row col-md-4 col-12 py-4 px-2 m-1 justify-content-center'>
            ...
            <Link className='btn btn-outline-success w-75' to='/clases'>
              Accede a mas info del Plan
            </Link>
          </div>
          ...
          <div className='planGym row col-md-4 col-12 py-4 px-2 m-1 justify-content-center'>
            ...
            <Link className='btn btn-outline-success w-75' to='/full'>
              Accede a mas info del Plan
            </Link>
          </div>
        </div>
